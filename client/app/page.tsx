      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Shopping Lists</h1>
          </div>
          <p className="text-gray-600 dark:text-gray-300">Create and manage your shopping lists with ease</p>
        </div>

        <Card className="mb-8">
          <CardHeader>
            <CardTitle>Create New List</CardTitle>
            <CardDescription>Start a new shopping list to organize your items</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        {recentLists.length > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your previously created shopping lists</CardDescription>
            </CardHeader>
            <CardContent>
